...
This document covers the core physical components that make up a computer system. Understanding hardware is important in cybersecurity because attackers often exploit hardware weaknesses, and defenders must understand how systems function at a basic level.
...
The CPU is the "brain" of the computer. It processes instructions from programs and the operating system.
...
RAM is temporary memory used to store data that the CPU needs quickly.
...
The PSU provides power to all components.
